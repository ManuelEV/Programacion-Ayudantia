...
public class IconDnD extends JFrame {
    ...
    private void initUI() {
        ...
        var icon1 = new ImageIcon("assets/images/sad.png");
        var icon2 = new ImageIcon("assets/images/plain.png");
        var icon3 = new ImageIcon("assets/images/smile.png");
