...
public class DocumentModelEx extends JFrame {
    ...
    private void createToolbar() {
        ...
        var bold = new ImageIcon("assets/images/bold.png");
        var italic = new ImageIcon("assets/images/italic.png");
        var strike = new ImageIcon("assets/images/strike.png");
        var underline = new ImageIcon("assets/images/underline.png");
